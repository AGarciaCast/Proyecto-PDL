...
Para las funciones, además, se guardará el número de parámetros, su tipo, la forma de paso de parámetros, el tipo del valor de retorno y etiqueta de funcion (formada por nombre y su posición en tabla de simbolos).
