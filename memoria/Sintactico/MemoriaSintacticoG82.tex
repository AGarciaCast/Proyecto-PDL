...
\subsection*{Error 1:}
\lstinputlisting[style=JavaScript]{Error1ST.txt}
\lstinputlisting[style=DOS]{MsgErr1ST.txt}

\subsection*{Error 2:}
\lstinputlisting[style=JavaScript]{Error2ST.txt}
\lstinputlisting[style=DOS]{MsgErr2ST.txt}

\subsection*{Error 3:}
\lstinputlisting[style=JavaScript]{Error3ST.txt}
\lstinputlisting[style=DOS]{MsgErr3ST.txt}

\subsection*{Prueba 1 Correcta:}
\lstinputlisting[style=JavaScript]{Prueba1ST.txt}
\subsubsection*{Parse a Derechas:}
\input{Prueba1Parse.txt}
\includepdf[pages=1,pagecommand={\subsubsection*{Árbol sintáctico:}},width=\textwidth]{Prueba1Arbol.pdf}
\includepdf[pages=2-,pagecommand={},width=\textwidth]{Prueba1Arbol.pdf}

\subsection*{Prueba 2 Correcta:}
\lstinputlisting[style=JavaScript]{Prueba2ST.txt}
\subsubsection*{Parse a Derechas:}
\input{Prueba2Parse.txt}
\includepdf[pages=1,pagecommand={\subsubsection*{Árbol sintáctico:}},width=\textwidth]{Prueba2Arbol.pdf}
\includepdf[pages=2-,pagecommand={},width=\textwidth]{Prueba2Arbol.pdf}


\subsection*{Prueba 3 Correcta:}
\lstinputlisting[style=JavaScript]{Prueba3ST.txt}
\subsubsection*{Parse a Derechas:}
\input{Prueba3Parse.txt}
\includepdf[pages=1,pagecommand={\subsubsection*{Árbol sintáctico:}},width=\textwidth]{Prueba3Arbol.pdf}
\includepdf[pages=2-,pagecommand={},width=\textwidth]{Prueba3Arbol.pdf}
