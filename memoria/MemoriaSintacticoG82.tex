...
Los posibles conflictos son:
	...
	Podemos ver como en los posibles estados con este conflicto, S$_0$, S$_2$, S$_3$, S$_4$, S$_6$, S$_{11}$, S$_{22}$, S$_{28}$, S$_{29}$, S$_{34}$, S$_{41}$, S$_{50}$, S$_{51}$, S$_{59}$, S$_{63}$, S$_{68}$, S$_{76}$, S$_{79}$, S$_{80}$, S$_{83}$, S$_{85}$, S$_{86}$, S$_{91}$, se verifica que 
...
Prueba 1 Correcta
\lstinputlisting{Prueba1.txt}
\input{Parse1.txt}\\

Prueba 2 Correcta
\lstinputlisting{Prueba2.txt}
\input{Parse2.txt}\\

Prueba 3 Correcta
\lstinputlisting{Prueba3.txt}
\input{Parse3.txt}\\

Error 1
\lstinputlisting{Prueba4.txt}
\input{Error4.txt}\\

Error 2
\lstinputlisting{Prueba5.txt}
\input{Error5.txt}\\

Error 3
\lstinputlisting{Prueba6.txt}
\input{Error6.txt}
